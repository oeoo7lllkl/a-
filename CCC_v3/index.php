    ...
    // 폼이 포스트 제출 됬을 때
        if(isset($_POST['num'])){
            ...
            if($_POST['num']=="move:left"){
                ...
                if($_SESSION['move_right']<=-$_SESSION['s6']/2){
                    $_SESSION['move_right']=$_SESSION['s6']/2;
                }
                //----------------------------------
            }
            // 
            ...
            if($_POST['num']=="move_up"){
                ...
                if($_SESSION['move_up']>$_SESSION['s7']/2-$_SESSION['move_speed']){
                    $_SESSION['move_up']=-$_SESSION['s7']/2+$man_height-$_SESSION['move_speed'];
                }
                //----------------------------------
            }
            // ------------------------------------------------------------------------------------------------
            ...
            if($_POST['num']=="move_down"){
                ...
                if($_SESSION['move_up']<=-$_SESSION['s7']/2+$man_height-$_SESSION['move_speed']){
                    $_SESSION['move_up']=$_SESSION['s7']/2-$_SESSION['move_speed'];
                }
                //----------------------------------
            }
                                ...
                                for($i=0;$i<count($_SESSION['clothes']['cloth']);$i++){
                                    if($_SESSION['clothes']['cloth'][$i]==$_SESSION['s2']){
                                        ...
                                        if($_SESSION['s-1']==0)
                                            ...
                                            f1($color,$_SESSION['clothes']['name'][$i],$session_num);
                                    }
                                }
                            }
                            ?>
